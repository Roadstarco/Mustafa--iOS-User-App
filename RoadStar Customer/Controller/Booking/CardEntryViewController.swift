...
protocol  CardEntryProtocol  {
    func didCompletedCardEntry(card: STPPaymentMethodCardParams)
}

class CardEntryViewController: UIViewController, STPPaymentCardTextFieldDelegate {
...
//        cardParams.cvc = "7997"
    ...
    {
        if self.paymentTextField.cardParams.cvc != nil && self.paymentTextField.cardParams.expMonth != nil && self.paymentTextField.cardParams.expYear != nil && self.paymentTextField.cardParams.number != nil
        {
            //
            self.dismiss(animated: true, completion: nil)
            delegate?.didCompletedCardEntry(card: self.paymentTextField.cardParams)
        }
    }
    ...
    func createTextField() {
        ...
        cardHolderNameTextField.addTarget(self, action: #selector(self.textFieldDidChange(_:)), for: .editingChanged)
...
extension CardEntryViewController: UITextFieldDelegate {
